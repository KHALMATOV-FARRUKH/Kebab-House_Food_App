                                    ...
                                    children: [
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        // Payment Method
                                            ...
                                            _isCashOnDeliveryActive ? CustomCheckBox(title: getTranslated('Оплата при Получении', context), index: 0) : SizedBox(),
                                                ...
                                                onPressed: () {
                                                  if (!_selfPickup && order.addressIndex == -1) {
                                                    ...
                                                    order.placeOrder(PlaceOrderBody(
                                                      ...
                                                      paymentMethod: _isCashOnDeliveryActive ? order.paymentMethodIndex == 0 ? 'Оплата при Получении' : null : null,
