                                ...
                                Row(children: [
                                  ...
                                  Builder(
                                    builder: (context) => Expanded(flex: 8, child: Row(children: [
                                      ...
                                      (order.trackModel.paymentStatus != 'paid' && order.trackModel.paymentMethod != 'Оплата при Доставке'
                                    ...
                                    !order.showCancelled ? Center(
                                      child: SizedBox(
                                        ...
                                        child: Row(children: [
                                          ...
                                          (order.trackModel.paymentStatus == 'unpaid' && order.trackModel.paymentMethod != 'Оплата при Доставке' && order.trackModel.orderStatus
